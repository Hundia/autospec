export const slidesHE = [
  ...
  // 6. reverseTax
  {
    ...
    subtitle: 'זה לא הקוד שכתבת. זה המחיר שאתה משלם בכל פעם שאתה רוצה להוסיף משהו חדש.',
    dayOne: {
      title: 'אתה רוצה פיצ\'ר +1',
      items: [
        'המוצר שבנית ב-AI עובד. יום 60.',
        'סשני הצ\'אט נעלמו — לא נכתב תיעוד.',
        'אתה פותח סשן AI חדש. הוא לא יודע מה קיים.',
        '"בואנו נוסיף את זרימת התשלום." אמור להיות פשוט.',
      ],
    },
    daySixty: {
      title: 'מה אתה עושה לפני שורה 1',
      items: [
        '4–8ש: קריאה מחדש של כל קובץ כדי להבין מה נבנה',
        '2–4ש: הנדסה לאחור של החלטות ארכיטקטורה שנעשו בצ\'אט',
        '2–4ש: מציאת נקודות הרחבה בטוחות — או סיכון לשבור מה שעובד',
        'רק אז: בניית הפיצ\'ר שרצית',
      ],
    },
    cost: { hours: 40, label: 'שעות עומס גילוי מחדש ברבעון — לפני שנכתבת שורת קוד חדשה אחת' },
    callout: '73% מפרויקטי AI ננטשים. לא כי הפיצ\'ר הראשון נכשל. כי הפיצ\'ר השני הפך לבלתי נגיש.',
  },
