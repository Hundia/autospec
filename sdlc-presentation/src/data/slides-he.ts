export const slidesHE = [
    ...
    stages: [
      {
        ...
        accent: 'blue',
        bullets: [
          'spec.md בעלת נאמנות גבוהה מגדיר את הבעיה בלבד — לא מימוש.',
          'GenAI הופך קלט לא מובנה (שיחות, כרטיסי Jira) לדרישות ברורות.',
          'אנטי-ריקבון ספסיפיקציות: spec.md מנוהל בגרסאות, מעודכן לפני שינויי קוד.',
          'אף סוכן לא רשאי להתחיל מימוש עד שמנהל המוצר אישר רשמית את הספסיפיקציה.',
        ],
        output: 'spec.md — מקור האמת היחיד',
      },
      {
        number: 2,
        emoji: '⚖️',
        name: 'יישור ואילוצים',
        tag: 'החוקה',
        owner: 'ארכיטקט + מנהל מוצר',
        hero: false,
        accent: 'violet',
        bullets: [
          'חוקי הפרויקט: ערימת טכנולוגיה, פרוטוקולי אבטחה, תקני ארכיטקטורה.',
          'אילוצים אלה מהווים את בסיס הסבכה — סוכנים לא יכולים להציע ארכיטקטורות מחוץ לספסיפיקציה.',
          'כולל דרישות SSDLC וגדרות כגבולות קוד-קשיח.',
          'ההחלטות היקרות ביותר לשינוי מאוחר יותר — השקע מראש.',
        ],
        output: 'constitution.md / מערכת אילוצים מוזרקת לכל סוכן',
      },
      {
        number: 3,
        emoji: '🗺️',
        ...
        accent: 'emerald',
        bullets: [
          'סוכנים מייצרים plan.md (אסטרטגיה טכנית) ו-tasks.md (יחידות גרגריות וניתנות לבדיקה).',
          'מהנדסים בכירים חוקרים את התכנית — לא כותבים אותה — מתמקדים באילוצי ירושה, אבטחה, רדיוס פגיעה.',
          'ראש הצוות מאשר את מפת המימוש לפני כל קוד.',
          'כל משימה ניתנת לבדיקה באופן עצמאי — זה מה שהופך בולטים לאפשריים.',
        ],
      ...
      },
      {
        ...
        accent: 'indigo',
        bullets: [
          'סוכנים מממשים משימות ביחידות קטנות וניתנות לבדיקה — שעות, לא שבועות.',
          'TDD נאכף: אין מימוש לפני קיום בדיקה כושלת.',
          'כל שגיאת סוכן מקודדת כבדיקת סבכה קבועה — היא לא יכולה לחזור.',
          'המפתח = מתאם איכות: סוקר PR של סוכנים, מקרי קצה, מתחזק סבכה.',
          'סוכנים פועלים בסנדבוקסים מאובטחים (מיכלים מבודדים / סשנים דינמיים).',
        ],
        output: 'קוד ממוזג ומאומת',
      },
      {
        number: 5,
        emoji: '🧪',
      ...
      },
      {
        ...
        bullets: [
          ...
          'הערות שחרור, תיעוד מקושר, קבצים שעודכנו, commit סוגר — הכל בארטיפקט אחד.',
          'הסוכן הבא קורא את הסיכום ויורש הקשר מלא תוך 30 שניות — ללא הנדסה הפוכה.',
          'כל ספק, כל סשן, כל חבר צוות ממשיך בדיוק מאיפה שהפסקתם.',
          'הסיכום הוא הזיכרון שה-AI מעולם לא קיבל.',
        ],
        output: 'bolts/bolt-X/summary.md — ידע קבוע, אפס אובדן הקשר',
      },
      {
        number: 7,
        emoji: '📡',
        name: 'היגוי מתמיד',
        tag: 'לולאת אובזרווביליות',
        owner: 'SRE / DevOps',
        hero: false,
        accent: 'orange',
        bullets: [
          'סוכנים מנטרים טלמטריה אמיתית מול ההתנהגות המיועדת של הספסיפיקציה; סטייה מפעילה התראות או בולט תיקון עצמי.',
          'סוכני SRE פותחים כריטיסים באופן יזום על אנומליות; GenAI כותב סיכומי אירועים.',
          'CI/CD נשאר קבוע — משמעת DevOps נמשכת לעולם האג\'נטי.',
          'כל תקשורות הסוכנים מתועדות לביקורת.',
        ],
  ...
  // 16. pipeline — SCROLLABLE
  {
    type: 'pipeline',
    scrollable: true,
    title: 'צינור ה-SDLC האג\'נטי',
    subtitle: 'מכוונה להיגוי — גלול את כל הלולאה',
    pipelineCallout: 'הצוות שמנהל לפני קידוד שולח מהר יותר מהצוות שמקדד לפני חשיבה. סיכום הבולט מבטיח שאף ידע לא יאבד לעולם.',
    steps: [
      {
        number: '01',
        title: 'לכידת כוונה',
        subtitle: 'GenAI מזקק שיחות + כרטיסים ל-spec.md בנאמנות גבוהה המתמקד רק בבעיה.',
        time: '1–2 שעות',
        output: 'spec.md',
        hero: false,
        accentColor: 'blue',
      },
      {
        number: '02',
        title: 'כתיבת החוקה',
        subtitle: 'חוקי ערימה, אבטחה וארכיטקטורה; מוזרקים לכל סוכן כגבולות קשיחים.',
        time: 'שעה',
      ...
      {
        number: '03',
        title: 'שער אישור ספסיפיקציה',
        subtitle: 'HITL: מנהל המוצר מאשר; סוכנים חסומים מכנית עד spec.approved = true.',
        time: '30 דקות',
        output: 'ספסיפיקציה מאושרת',
        hero: false,
        accentColor: 'rose',
      },
      {
        number: '04',
        title: 'תכנון ומשימות',
        subtitle: 'סוכנים גוזרים plan.md + tasks.md; בכירים חוקרים את התכנית.',
        time: 'שעה',
        output: 'plan.md, tasks.md',
        hero: false,
        accentColor: 'emerald',
      },
      {
        number: '05',
        title: 'ביצוע בולטים',
        subtitle: 'סוכנים עם TDD נאכף מממשים משימות ניתנות לבדיקה עצמאית בעצי עבודה מקבילים. שעות, לא שבועות.',
        time: '2–6 שעות',
        output: 'קוד עובד',
        hero: true,
        accentColor: 'indigo',
      },
      {
        number: '06',
        title: 'אימות סבכה',
        subtitle: 'בדיקות, linters, טיפוסים, סקירת קוד AI; כל כשל הופך לבדיקה קבועה.',
        time: 'רציף',
        output: 'סבכה ירוקה',
        hero: false,
        accentColor: 'cyan',
      },
      {
        number: '07',
        title: 'בולטי QA',
        subtitle: 'סוכני QA בונים חבילות E2E מקריטריוני הקבלה של הספסיפיקציה.',
        time: '1–2 שעות',
        output: 'חבילות בדיקה',
        hero: false,
        accentColor: 'green',
      },
      {
        number: '08',
        title: 'סקירה אנושית',
        subtitle: 'בעל התוצאות מאמת על preprod; מאשר או מבקש שינויים. שיפוט אנושי לפני פרודקשן.',
        time: 'שעה',
        output: 'אישור',
        hero: false,
        accentColor: 'amber',
      ...
      {
        number: '09',
        title: 'סיכום: סגירת בולט',
        subtitle: 'ייצור סיכום הבולט: הערות שחרור, קישורי מסמכים, קבצים שונו, commit סגירה. זו הקסם — הסוכן הבא יורש הכל.',
        time: '5 דקות',
        output: 'summary.md',
        hero: true,
        accentColor: 'teal',
      },
      {
        number: '10',
        title: 'היגוי מתמיד',
        subtitle: 'סוכני אובזרווביליות משווים טלמטריה לכוונת הספסיפיקציה; סטייה פותחת בולט תיקון עצמי. המערכת מנהיגה את עצמה.',
        time: 'תמיד פעיל',
        output: 'מערכת של היגוי עצמי',
        hero: false,
        accentColor: 'orange',
      },
    ],
  ...
  // 17. sprintMemorySlide
  {
    ...
    title: 'סיכום: שכבת הזיכרון',
    subtitle: 'מסמך המסירה שמעולם לא היה קיים',
    summary: {
      command: '> /bolt-close',
      progress: 'סוגר בולט 11... מייצר סיכום...',
      result: '✓ bolts/bolt-11/summary.md נוצר',
      sections: [
        { label: 'הערות שחרור', color: 'blue', items: ['נוסף JWT auth עם refresh tokens', 'דף כניסה עם OTP', '3 נקודות קצה API חדשות'] },
        { label: 'מסמכים מקושרים', color: 'violet', items: ['docs/auth/01-architecture.md', 'docs/auth/02-jwt-flow.md', 'docs/frontend/03-login-page.md'] },
        { label: 'קבצים שונו', color: 'green', items: ['+ src/auth/auth.service.ts', '+ src/auth/auth.guard.ts', '~ src/pages/Login.tsx', '... 12 נוספים'] },
        { label: 'Commit סגירה', color: 'amber', items: ['a3f7c21 feat(bolt-11): auth + login'] },
      ],
    },
    benefits: [
      { icon: '⚡', title: 'הקשר מיידי', description: 'סוכן קורא סיכום → הקשר מלא ב-30 שניות' },
      { icon: '🔍', title: 'השוואת בולטים', description: 'השווה בולט 3 לבולט 7 → ראה בדיוק מה השתנה' },
      { icon: '🚫', title: 'אין קריאת קוד', description: 'הכל מקושר — אין צורך בהנדסה לאחור' },
      { icon: '🤝', title: 'מסירה מושלמת', description: 'כל סוכן, כל ספק, ממשיך מהמקום שעצרת' },
    ],
    callout: 'הסיכום הוא הזיכרון שה-AI לא קיבל מעולם.',
  },
