export const slidesHE = [
  ...
  // 12. agentic5Acts — SCROLLABLE
  {
    ...
    closingCallout: 'ציין. ארכיטקט. בולט. זכור. נווט. חמש משמעות שמקמצות את השעון — מבלי לדלג על שלב אחד.',
    keyInsight: {
    ...
    acts: [
      {
        ...
        stageRef: 'שלבים 1–2',
        owners: ['מנהל מוצר', 'ארכיטקט', 'מהנדס מערכת תוכנה'],
        hero: false,
        accent: 'blue',
        bullets: [
        ...
        output: 'spec.md / מסמך דרישות + constitution.md + Instructions & Skills',
      },
      {
        number: 'II',
        name: 'ARCHITECT',
        ...
        bullets: [
          ...
          'המשימות תוכננו להיות בדיקות עצמאיות ומנותקות ככל הניתן — מאפשרות ביצוע מקבילי אג\'נטי לפי עיצוב.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'ראש צוות QA מממש וגם מריץ בדיקות מערכת מבוססות תרחישים בקבצי Feature Specs .md. כל בדיקה חדשה מתווספת לרגרסיה; חבילה מלאה רצה על כל סגירת בולט.',
        ],
        output: 'קוד ממוזג, סקור HITL, ירוק-רגרסיה',
      },
      {
        number: 'IV',
        name: 'REMEMBER',
        ...
        bullets: [
          ...
          'הערות שחרור, מסמכים מקושרים, קבצים שונו, commit סגירה — הכל בארטיפקט אחד.',
      ...
      },
      {
        ...
        accent: 'orange',
        bullets: [
          'סוכני אובזרווביליות מנטרים טלמטריה בזמן-אמת מול ההתנהגות המיועדת של ה-spec — מבוסס על מדדים ולוגים.',
