...
function KanbanTab() {
  ...
  return (
    <svg viewBox="0 0 500 220" className="w-full" aria-label="Cycle Kanban Board">
      <SvgDefs />
      ...
      {/* Title */}
      <text x="250" y="22" textAnchor="middle" fill="#e2e8f0" fontSize="11" fontWeight="700" fontFamily="monospace">Cycle Kanban Board</text>
