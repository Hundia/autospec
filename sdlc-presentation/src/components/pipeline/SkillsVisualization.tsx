...
const skillLines = {
  en: [
    ...
    'sprint-run.md         # Execute full sprint cycle',
    'plan-sprint.md        # Plan next sprint from backlog',
    'sprint-status.md      # Check sprint progress',
    'create-spec.md        # Generate role-based spec',
    'qa-review.md          # QA verification checklist',
    'update-backlog.md     # Update ticket statuses',
    'sprint-close.md       # Close sprint + summary',
    'create-sprint-docs.md # Generate sprint docs',
  ...
  he: [
    ...
    'sprint-run.md         # הרץ מחזור sprint מלא',
    'plan-sprint.md        # תכנן sprint הבא',
    'sprint-status.md      # בדוק התקדמות sprint',
    'create-spec.md        # הפק מפרט מבוסס תפקיד',
    'qa-review.md          # צ\'קליסט אימות QA',
    'update-backlog.md     # עדכן סטטוס משימות',
    'sprint-close.md       # סגור sprint + סיכום',
    'create-sprint-docs.md # הפק דוקומנטציית sprint',
