...
MealMap is a recipe and meal planning application built using the AutoSpec Spec-Driven Development (SDD) framework. All implementation is driven by the specs in `specs/`.
