...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 0.1 | Scaffold mono-repo service layout | Create api, worker, web, and viewer-ready data package skeleton with shared configs. | 5 | qa-review | DevOps | gpt-5.2 | - |
| 0.2 | Create tenant and identity schema baseline | Model workspaces, users, roles, queues, and session tables with migration strategy. | 3 | qa-review | DB | gpt-5.3 | 0.1 |
| 0.3 | Implement queue and ticket walking skeleton | Expose health, auth bootstrap, queue list, and basic ticket create/read endpoints. | 5 | qa-review | Backend | gpt-5.3 | 0.2 |
| 0.4 | Build support workspace shell | Create dashboard shell, navigation, queue list view, and shared design tokens. | 3 | qa-review | Frontend | gpt-5.2 | 0.1 |
| 0.5 | Add CI, Docker, and quality gates | Wire lint, typecheck, tests, build, and Docker Compose for local and CI usage. | 4 | blocked | DevOps | gpt-5.4 | 0.1, 0.2, 0.3, 0.4 |
