              ...
              return (
                ...
                >
                  ...
                  <text
                    ...
                    fontSize={9} fill="#574b3b" fontFamily="Inter, sans-serif"
                  ...
                  {isHovered && msg.description && (
                    <foreignObject x={fromX + loopW + 4} y={y + 8} width={180} height={40}>
                      <div style={{ fontSize: 8, color: '#a08c72', fontFamily: 'Inter, sans-serif' }}>
                        {msg.description}
                      </div>
                    </foreignObject>
                  )}
            ...
            return (
              ...
              >
                ...
                <rect
                  ...
                  height={14}
                  rx={4}
                  fill={isHovered ? '#faf9f5' : 'transparent'}
                  stroke={isHovered ? '#e8e4d8' : 'none'}
                />
                <text
                  x={(startX + endX) / 2}
                  y={y - 6}
                ...
                {isHovered && msg.description && (
                  ...
                  >
                    <div style={{
                      fontSize: 8, color: '#a08c72', textAlign: 'center',
