...
## Sprint 20: AI Support Ops Example + Copilot GPT-5.x Validation (~13 pts)

**Theme:** Create a new example app that stress-tests AutoSpec's docs, specs, viewer outputs, and model-routing behavior for GitHub Copilot with GPT-5.4 planning and GPT-5.2/5.3 execution.
**Status:** 🔄 In Progress

| ID | Ticket | Owner | Pts | Status | Deps | Docs |
|----|--------|-------|-----|--------|------|------|
| 20.1 | Create local scaffold — `PLAN.md`, `README.md`, and `requirements/srs.md` for an AI-native support operations app | PM | 3 | ✅ | — | `PLAN.md`, `README.md`, `requirements/srs.md` |
| 20.2 | Isolate generated output under `project/` and remove nested git metadata | DevOps | 2 | ✅ | 20.1 | `project/` |
| 20.3 | Patch Copilot GPT-5.x generation assets in the local clone — `QUICKSTART.md`, Copilot docs, and instruction templates | PM | 3 | ✅ | 20.2 | `QUICKSTART.md`, `docs/environments/vscode/github_copilot.md`, `skills/copilot/instructions.md`, `autospec-starter/.github/copilot-instructions.md` |
| 20.4 | Execute local `QUICKSTART.md` against `requirements/srs.md` to generate specs, docs, prompts, sprint artifacts, and Copilot instructions into `project/` | PM | 3 | ✅ | 20.3 | `project/` |
| 20.5 | Review generated outputs for GPT-5.x routing, Copilot instructions, and viewer-facing richness | QA | 2 | ✅ | 20.4 | `project/specs/backlog.md`, `project/.github/copilot-instructions.md` |
| 20.6 | Write formal validation report comparing generated output against Quickstart promises and GPT-5.x workflow goals | PM | 2 | ✅ | 20.5 | `REVIEW.md` |
| 20.7 | Harden weak generated artifacts — API docs, flows, testing docs, sprint prompts, and Copilot handoff workflow | PM | 3 | ✅ | 20.5 | `project/docs/`, `project/prompts/`, `project/.github/copilot-instructions.md` |
| 20.8 | Run Sprint 0 validation drill and document what the generated prompts prove vs where they block | QA | 2 | ✅ | 20.7 | `project/sprints/sprint_0/validation_drill.md` |
| 20.9 | Create a strict viewer-readiness benchmark and score the generated project against one-shot viewer goals | QA | 2 | ✅ | 20.5 | `VIEWER_BENCHMARK.md` |
| 20.10 | Write a framework improvement proposal from the validation findings without changing root AutoSpec | PM | 3 | ✅ | 20.6, 20.7, 20.8, 20.9 | `FRAMEWORK_PROPOSAL.md` |
...
| Sprint 18 | 16 | ✅ Done |
| Sprint 19 | 37 | ✅ Done |
| Sprint 20 | 25 | 🔄 In Progress |
| **Total** | **676** | 🔄 **IN PROGRESS** |
