export const slidesHE = [
  ...
  // 21. futureWaterfall
  {
    ...
    allocation: [
      { phase: 'תכנון ומפרטים', percentage: 50, color: 'blue', description: 'הבנה של מה לבנות היא ההשקעה הגדולה. הגדר נכון, סוכנים מבצעים נכון.' },
      { phase: 'פיתוח', percentage: 20, color: 'green', description: 'עם מפרטים ברורים, גם מודלים קטנים מספקים תוצאות ברמה גבוהה. ה"חתיכה הקטנה" של העתיד.' },
  ...
  {
    type: 'oneMoreThing',
    title: 'אה, ועוד דבר אחד...',
    subtitle: 'התעשייה כבר בונה את מה שתיארנו',
    insights: [
      {
        title: 'TypeScript לפיתוח אג\'נטי',
        description: 'מערכת הטיפוסים = מעקות בטיחות שמונעים סחיפת הזיות. טיפוסים מגבילים את מה ש-AI יכול לייצר, ותופסים שגיאות לפני ריצה.',
        icon: '🔷',
        color: 'blue',
      },
      {
        title: 'בדיקות Copilot מרובות טרמינלים',
        description: 'Copilot מריץ מספר טרמינלים, מבצע E2E אמיתי — לא רק בדיקות יחידה. אימות full-stack מפרומפט אחד.',
        icon: '🖥️',
        color: 'green',
      },
      {
        title: 'Playwright E2E לסוכני AI',
        description: 'סוכני AI בודקים אפליקציות ווב דרך דפדפנים אמיתיים. אותו כלי שאנחנו משתמשים ב-AutoSpec — עכשיו פרקטיקה סטנדרטית.',
        icon: '🎭',
        color: 'violet',
      },
      {
        title: 'Copilot /fleet',
        description: 'תת-סוכנים מקביליים — אותה תבנית כמו ה-orchestrator של AutoSpec, מובנית ב-CLI. העתיד כבר כאן.',
        icon: '🚀',
        color: 'amber',
      },
      {
        title: 'תכנן קודם, בצע אחר כך',
        description: 'לעולם אל תבצע — אפילו לא את המשימה הפשוטה ביותר — בלי תוכנית. חשוב, עצב, אמת, ואז בנה. זו המשמעת הליבתית של פיתוח אג\'נטי.',
        icon: '🧭',
        color: 'cyan',
      },
    ],
