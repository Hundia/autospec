...
const skillLines = {
  ...
  he: [
    ...
    'sprint-run.md         # הרץ מחזור ספרינט מלא',
    'plan-sprint.md        # תכנן ספרינט הבא',
    'sprint-status.md      # בדוק התקדמות ספרינט',
    'create-spec.md        # הפק מפרט מבוסס תפקיד',
    'qa-review.md          # צ\'קליסט אימות QA',
    'update-backlog.md     # עדכן סטטוס משימות',
    'sprint-close.md       # סגור ספרינט + סיכום',
    'create-sprint-docs.md # הפק דוקומנטציית ספרינט',
