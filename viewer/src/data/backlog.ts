...
export const backlogData: Sprint[] = [
  ...
  },
  {
    ...
    totalPoints: 58,
    tickets: [
      { id: '11.1', title: 'Update slides-en.ts with 7 new slide data entries + reorder', owner: 'Frontend', points: 5, status: 'todo', dependencies: [] },
      { id: '11.2', title: 'Update slides-he.ts with Hebrew translations', owner: 'Frontend', points: 3, status: 'todo', dependencies: ['11.1'] },
      { id: '11.3', title: 'SprintLifecycleSlide.tsx', owner: 'Frontend', points: 3, status: 'todo', dependencies: ['11.1'] },
      { id: '11.4', title: 'OrchestratorSlide.tsx', owner: 'Frontend', points: 3, status: 'todo', dependencies: ['11.1'] },
      { id: '11.5', title: 'QAMethodologySlide.tsx', owner: 'Frontend', points: 3, status: 'todo', dependencies: ['11.1'] },
      { id: '11.6', title: 'SprintSummarySlide.tsx', owner: 'Frontend', points: 3, status: 'todo', dependencies: ['11.1'] },
      { id: '11.7', title: 'SkillsEnvironmentsSlide.tsx', owner: 'Frontend', points: 3, status: 'todo', dependencies: ['11.1'] },
      { id: '11.8', title: 'ViewerSlide.tsx', owner: 'Frontend', points: 3, status: 'todo', dependencies: ['11.1'] },
      { id: '11.9', title: 'FinOpsSlide.tsx', owner: 'Frontend', points: 3, status: 'todo', dependencies: ['11.1'] },
      { id: '11.10', title: 'Wire slides into PresentationPage.tsx', owner: 'Frontend', points: 2, status: 'todo', dependencies: ['11.3', '11.4', '11.5', '11.6', '11.7', '11.8', '11.9'] },
      { id: '11.11', title: 'OrchestratorSection.tsx for landing', owner: 'Frontend', points: 5, status: 'todo', dependencies: [] },
      { id: '11.12', title: 'QASection.tsx for landing', owner: 'Frontend', points: 5, status: 'todo', dependencies: [] },
      { id: '11.13', title: 'SprintLifecycleSection.tsx for landing', owner: 'Frontend', points: 5, status: 'todo', dependencies: [] },
      { id: '11.14', title: 'Update LandingPage.tsx + StatsSection', owner: 'Frontend', points: 2, status: 'todo', dependencies: ['11.11', '11.12', '11.13'] },
      { id: '11.15', title: 'Fix mobile progress dots for 18 slides', owner: 'Frontend', points: 3, status: 'todo', dependencies: ['11.10'] },
      { id: '11.16', title: 'Build verification + RTL QA', owner: 'QA', points: 2, status: 'todo', dependencies: ['11.14', '11.15'] },
